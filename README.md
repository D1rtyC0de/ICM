...
/* Tokenomics:
        ...
        --->Holders Rewards: 2%
        --->Lp Pool: 2%
        --->Charity and Marketing: 2 & 2% will be changed to all charity when goal market caps are met!
*/
...
contract ICEMOON is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4A1ef2AD15690790985ab2aFD0E5E4634D735076;
